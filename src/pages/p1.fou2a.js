...
// ====================
// PAGE P1 - Member Plans
// ====================
$w.onReady(async function () {
    const hasAccess = await protectPage([ROLES.CCS_MEMBER, ROLES.LEGACY_CS_MEMBER]);
    if (!hasAccess) return;
    
    // User verified - show member plans content
    console.log("Showing member plans");
});
